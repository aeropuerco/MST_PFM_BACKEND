...
Deploy completado y funcionando. Preparando parte FRONT ;)
...
- Un editor básico de "Posts" o "Paginas" que tenga para incluir Titulos, Parrafos, Imagenes, etc.. en cualquier cantidad.
